...
- For wording such as `operations for process orders`, `process order operation records`, or `process order operation details`, select only `A_ProcessOrderOperation_2.OrderIntBillOfOperationsItem`, `A_ProcessOrderOperation_2.OrderInternalBillOfOperations`, `A_ProcessOrderOperation_2.ManufacturingOrder`, `A_ProcessOrderOperation_2.ManufacturingOrderSequence`, `A_ProcessOrderOperation_2.MfgOrderSequenceText`, `A_ProcessOrderOperation_2.ManufacturingOrderOperation`, `A_ProcessOrderOperation_2.ManufacturingOrderSubOperation`, and `A_ProcessOrderOperation_2.ManufacturingOrderCategory`.
